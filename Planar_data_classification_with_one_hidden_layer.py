...
def update_parameters(parameters, grads, learning_rate = 1.2):
    ...
    # b2 = ...
    # YOUR CODE STARTS HERE
    W1,b1 = copy.deepcopy(parameters["W1"]),copy.deepcopy(parameters["b1"])
    W2,b2 = copy.deepcopy(parameters["W2"]),copy.deepcopy(parameters["b2"])
    ...
    # db2 = ...
    # YOUR CODE STARTS HERE
    dW1, db1 = copy.deepcopy(grads["dW1"]),copy.deepcopy(grads["db1"])
    dW2, db2 = copy.deepcopy(grads["dW2"]),copy.deepcopy(grads["db2"])
